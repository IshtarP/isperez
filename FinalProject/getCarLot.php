...
$dbConn = getDatabaseConnection("final_project");
    ...
    while(  $row = $stmt->fetch()) {
        ...
        $htmlToReturn .= sprintf("<td><img src='%s'/><td>%s</td><td>%s</td><td>%s</td><td>$%s</td></td><td>%s</td><td>%s</td><td>%s</td>",$picture,$make,$model,$year,$price,$exterior_color,$used_or_new,$del);
